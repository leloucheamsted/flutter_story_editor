  ...
  void paint(Canvas canvas, Size size) {
    Paint paint = Paint()
      ...
      ..filterQuality = FilterQuality
          .high // Higher quality filter settings for better anti-aliasing.
      ..style =
          PaintingStyle.fill; // The paint will be used to fill the drawing.
    ...
    for (Stroke line in lines) {
      ...
      final outlinePoints = getStroke(
        ...
        options: StrokeOptions(
          ...
          thinning: options
              .thinning, // The degree to which the stroke thickness is reduced based on velocity.
          smoothing: options
              .smoothing, // How much the input points are smoothed before drawing.
          streamline: options
              .streamline, // How much the input points are corrected to form a smoother line.
          start: options.start, // Start tapering length.
          end: options.end, // End tapering length.
          simulatePressure:
              options.simulatePressure, // Simulates pressure sensitivity.
          isComplete:
              options.isComplete, // Indicates if the stroke is complete.
        ),
      );
